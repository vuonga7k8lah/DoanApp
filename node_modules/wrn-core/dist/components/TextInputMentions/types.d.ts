...
export declare type Selection = TextInputSelectionChangeEventData['selection'];
export declare type SelectionChangeEvent = NativeSyntheticEvent<TextInputSelectionChangeEventData>;
