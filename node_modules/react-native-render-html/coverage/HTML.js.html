...
<head>
    <title>Code coverage report for HTML.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> HTML.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">74.43% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>131/176</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>143/204</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>125/169</span>
            </div>
...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4800x</span>
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">120x</span>
...
&nbsp;
    constructor (props) {
        ...
        this.renderers = {
            ...HTMLRenderers,
            ...(this.props.renderers || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>
        };
        this.mounted = false;
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (renderers !== this.props.renderers) {
<span class="cstat-no" title="statement not covered" >            this.renderers = { ...HTMLRenderers, ...(this.props.renderers || {}) };</span>
        }
        <span class="missing-if-branch" title="if path not taken" >I</span>if (html !== this.props.html || uri !== this.props.uri) {
            // If the source changed, register the new HTML and parse it
<span class="cstat-no" title="statement not covered" >            this.registerDOM(this.props);</span>
        }
...
&nbsp;
    async registerDOM (props = this.props, cb) {
        ...
        } else <span class="cstat-no" title="statement not covered" >if (props.uri) {</span>
<span class="cstat-no" title="statement not covered" >            try {</span>
                // WIP : This should render a loader and html prop should not be set in state
                // Error handling would be nice, too.
<span class="cstat-no" title="statement not covered" >                try {</span>
<span class="cstat-no" title="statement not covered" >                    this.setStateSafe({ loadingRemoteURL: true, errorLoadingRemoteURL: false });</span>
                    const response = <span class="cstat-no" title="statement not covered" >await fetch(uri);</span>
                    const dom = <span class="cstat-no" title="statement not covered" >await response.text();</span>
<span class="cstat-no" title="statement not covered" >                    this.setStateSafe({ dom, loadingRemoteURL: false });</span>
                } catch (err) {
<span class="cstat-no" title="statement not covered" >                    console.warn(err);</span>
<span class="cstat-no" title="statement not covered" >                    this.setStateSafe({ errorLoadingRemoteURL: true, loadingRemoteURL: false });</span>
                }
            } catch (err) {
<span class="cstat-no" title="statement not covered" >                console.warn('react-native-render-html', `Couldn't fetch remote HTML from uri : ${uri}`);</span>
<span class="cstat-no" title="statement not covered" >                return false;</span>
            }
        } else {
<span class="cstat-no" title="statement not covered" >            console.warn('react-native-render-html', 'Please provide the html or uri prop.');</span>
        }
    }
&nbsp;
    parseDOM (dom, props = <span class="branch-0 cbranch-no" title="branch not covered" >this.props)</span> {
        ...
        const parser = new Parser(
            new DomHandler((_err, dom) =&gt; {
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (onParsed) {
                    const alteredRNElements = <span class="cstat-no" title="statement not covered" >onParsed(dom, RNElements);</span>
<span class="cstat-no" title="statement not covered" >                    if (alteredRNElements) {</span>
<span class="cstat-no" title="statement not covered" >                        RNElements = alteredRNElements;</span>
                    }
                }
...
<span class="cstat-no" title="statement not covered" >                    console.log('DOMNodes from htmlparser2', dom);</span>
<span class="cstat-no" title="statement not covered" >                    console.log('RNElements from render-html', RNElements);</span>
                }
            }),
...
&nbsp;
    generateDefaultStyles (baseFontStyle = <span class="branch-0 cbranch-no" title="branch not covered" >this.props.baseFontStyle)</span> {
        this.defaultBlockStyles = generateDefaultBlockStyles(baseFontStyle.fontSize || <span class="branch-1 cbranch-no" title="branch not covered" >14)</span>;
        this.defaultTextStyles = generateDefaultTextStyles(baseFontStyle.fontSize || <span class="branch-1 cbranch-no" title="branch not covered" >14)</span>;
    }
&nbsp;
    /**
    ...
    associateRawTexts (children) {
        for (let i = 0; i &lt; children.length; i++) {
            ...
            if (
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (wrappedTexts.length) {
                    children[i] = {
                        attribs: {},
...
&nbsp;
     ...
     * @memberof HTML
     */
    mapDOMNodesTORNElements (DOMNodes, parentTag = <span class="branch-0 cbranch-no" title="branch not covered" >false,</span> props = this.props) {
        ...
        let RNElements = DOMNodes.map((node, nodeIndex) =&gt; {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (ignoreNodesFunction &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >ignoreNodesFunction(node, parentTag) === true)</span> {
<span class="cstat-no" title="statement not covered" >                return false;</span>
            }
            <span class="missing-if-branch" title="if path not taken" >I</span>if (ignoredTags.map((tag) =&gt; tag.toLowerCase()).indexOf(node.name &amp;&amp; node.name.toLowerCase()) !== -1) {
<span class="cstat-no" title="statement not covered" >                return false;</span>
            }
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (alterNode) {
                const alteredNode = <span class="cstat-no" title="statement not covered" >alterNode(node);</span>
<span class="cstat-no" title="statement not covered" >                node = alteredNode || node;</span>
            }
            const { type, attribs, name, parent } = node;
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (alterData &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >data)</span> {
                const alteredData = <span class="cstat-no" title="statement not covered" >alterData(node);</span>
<span class="cstat-no" title="statement not covered" >                data = alteredData || data;</span>
            }
            <span class="missing-if-branch" title="if path not taken" >I</span>if (alterChildren &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >children)</span> {
                const alteredChildren = <span class="cstat-no" title="statement not covered" >alterChildren(node);</span>
<span class="cstat-no" title="statement not covered" >                children = alteredChildren || children;</span>
            }
            // Remove whitespaces to check if it's just a blank text
            const strippedData = data &amp;&amp; data.replace(/\s/g, '');
            if (type === 'text') {
                <span class="missing-if-branch" title="if path not taken" >I</span>if (!strippedData || !strippedData.length) {
...
&nbsp;
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (type === 'tag') {
        ...
        .map((parsedNode, nodeIndex) =&gt; {
            ...
            if (firstChild &amp;&amp; children.length === 1) {
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if ((attribs === firstChild.attribs || !firstChild.attribs) &amp;&amp;
<span class="branch-2 cbranch-no" title="branch not covered" >                    firstChild.wrapper === wrapper </span>&amp;&amp;
                    (<span class="branch-3 cbranch-no" title="branch not covered" >tagName === firstChild.tagName </span>|| <span class="branch-4 cbranch-no" title="branch not covered" >firstChild.tagName === 'rawtext')</span>) {
...
&nbsp;
                ...
                Object.keys(wrapperStyles).forEach(<span class="fstat-no" title="function not covered" >(s</span>tyleKey) =&gt; {
                    // Extract text-only styles
<span class="cstat-no" title="statement not covered" >                    if (TextOnlyPropTypes.indexOf(styleKey) !== -1) {</span>
<span class="cstat-no" title="statement not covered" >                        textChildrenInheritedStyles[styleKey] = wrapperStyles[styleKey];</span>
<span class="cstat-no" title="statement not covered" >                        delete wrapperStyles[styleKey];</span>
                    }
                });
                <span class="missing-if-branch" title="else path not taken" >E</span>if (Object.keys(textChildrenInheritedStyles).length === 0) {
                    // No style to apply to text children, avoid unecessary loops
                    return parsedNode;
                }
                // Re-write wrapper's styles as a string
<span class="cstat-no" title="statement not covered" >                parsedNode.attribs.style = cssObjectToString(wrapperStyles);</span>
<span class="cstat-no" title="statement not covered" >                for (let i = <span class="cstat-no" title="statement not covered" >0;</span> i &lt; children.length; i++) {</span>
                    const child = <span class="cstat-no" title="statement not covered" >children[i];</span>
                    const { wrapper, attribs } = <span class="cstat-no" title="statement not covered" >child;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (wrapper === 'Text') {</span>
                        // Set (or merge) the inherited text styles extracted from the wrapper for
                        // each Text child
<span class="cstat-no" title="statement not covered" >                        if (!attribs.style) {</span>
<span class="cstat-no" title="statement not covered" >                            child.attribs.style = cssObjectToString(textChildrenInheritedStyles);</span>
                        } else {
<span class="cstat-no" title="statement not covered" >                            child.attribs.style = cssObjectToString({</span>
...
&nbsp;
     ...
     * @memberof HTML
     */
    renderRNElements (RNElements, parentWrapper = <span class="branch-0 cbranch-no" title="branch not covered" >'root',</span> parentIndex = <span class="branch-0 cbranch-no" title="branch not covered" >0,</span> props = <span class="branch-0 cbranch-no" title="branch not covered" >this.props)</span> {
        const {
            allowFontScaling,
            allowedStyles,
            baseFontStyle,
        ...
        return RNElements &amp;&amp; RNElements.length ? RNElements.map((element, index) =&gt; {
            ...
            const convertedCSSStyles =
                attribs &amp;&amp; attribs.style ?
                    cssStringToRNStyle(
                        attribs.style,
                        Wrapper === Text ? STYLESETS.TEXT : <span class="branch-1 cbranch-no" title="branch not covered" >STYLESETS.VIEW,</span> // proper prop-types validation
...
&nbsp;
                <span class="missing-if-branch" title="if path not taken" >I</span>if (!customRenderer || typeof customRenderer !== 'function') {
<span class="cstat-no" title="statement not covered" >                    console.warn(`Custom renderer for ${tagName} supplied incorrectly. Please check out the docs.`);</span>
...
&nbsp;
            const style = [
                (!tagsStyles || !tagsStyles[tagName]) ? (Wrapper === Text ? this.defaultTextStyles : this.defaultBlockStyles)[tagName] : <span class="branch-1 cbranch-no" title="branch not covered" >undefined,</span>
                tagsStyles ? tagsStyles[tagName] : <span class="branch-1 cbranch-no" title="branch not covered" >undefined,</span>
                classStyles,
                convertedCSSStyles
            ]
...
&nbsp;
    render () {
        ...
        if (!RNNodes &amp;&amp; !loadingRemoteURL &amp;&amp; !errorLoadingRemoteURL) {
            return null;
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (loadingRemoteURL) {
<span class="cstat-no" title="statement not covered" >            return remoteLoadingView ?</span>
        ...
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (errorLoadingRemoteURL) {
<span class="cstat-no" title="statement not covered" >            return remoteErrorView ?</span>
...
&nbsp;
        return customWrapper ? <span class="branch-0 cbranch-no" title="branch not covered" >customWrapper(RNNodes) </span>: (
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Sat Dec 05 2020 15:47:44 GMT-0300 (Brasilia Standard Time)
            </div>
        </div>
