...
<head>
    <title>Code coverage report for HTMLStyles.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> HTMLStyles.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">89.13% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>82/92</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>81/91</span>
            </div>
...
&nbsp;
export function <span class="fstat-no" title="function not covered" >cssObjectToString(</span>obj) {
  let string = <span class="cstat-no" title="statement not covered" >"";</span>
<span class="cstat-no" title="statement not covered" >  Object.keys(obj).forEach(<span class="fstat-no" title="function not covered" >(s</span>tyle) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    string += `${style}:${obj[style]};`;</span>
  });
...
export function _constructStyles({
  ...
  passProps,
  additionalStyles,
  styleSet = <span class="branch-0 cbranch-no" title="branch not covered" >"VIEW",</span>
  baseFontSize,
}) {
...
&nbsp;
  passProps.ignoredStyles.forEach(<span class="fstat-no" title="function not covered" >(i</span>gnoredStyle) =&gt; {
<span class="cstat-no" title="statement not covered" >    htmlAttribs[ignoredStyle] &amp;&amp; delete htmlAttribs[ignoredStyle];</span>
  });
&nbsp;
  let style = [
    (styleSet === "VIEW" ? defaultBlockStyles : defaultTextStyles)[tagName],
    passProps.tagsStyles ? passProps.tagsStyles[tagName] : <span class="branch-1 cbranch-no" title="branch not covered" >undefined,</span>
    _getElementClassStyles(htmlAttribs, passProps.classesStyles),
    htmlAttribs.style
      ? <span class="branch-0 cbranch-no" title="branch not covered" >cssStringToRNStyle(htmlAttribs.style, STYLESETS[styleSet], {</span>
          ...passProps,
          parentTag: tagName,
        })
      : undefined,
...
&nbsp;
  if (additionalStyles) {
    style = style.concat(
      !additionalStyles.length ? <span class="branch-0 cbranch-no" title="branch not covered" >[additionalStyles] </span>: additionalStyles
    );
  }
&nbsp;
...
&nbsp;
  ...
  parentStyles.forEach((styles) =&gt; {
    Object.keys(styles).forEach((styleKey) =&gt; {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!finalStyle[styleKey]) {
 ...
 * @returns {object}
 */
export function _getElementClassStyles(htmlAttribs, classesStyles = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
  const elementClasses = _getElementCSSClasses(htmlAttribs);
  let styles = {};
  elementClasses.forEach((className) =&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (classesStyles[className]) {
...
function cssToRNStyle(
  ...
  return Object.keys(css)
    .filter((key) =&gt; (allowedStyles ? <span class="branch-0 cbranch-no" title="branch not covered" >allowedStyles.indexOf(key) !== -1 </span>: true))
    .filter((key) =&gt; (ignoredStyles || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>.indexOf(key) === -1)
    .map((key) =&gt; [key, css[key]])
    .map(([key, value]) =&gt; {
      // Key convert
      return [
    ...
    .map(([key, value]) =&gt; {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof value === "string") {
        ...
        if (key !== "fontWeight" &amp;&amp; !isNaN(numericValue)) {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (styleProps.indexOf(key) !== -1) {
            return [key, numericValue];
          }
        }
        <span class="missing-if-branch" title="if path not taken" >I</span>if (key === "fontSize") {
<span class="cstat-no" title="statement not covered" >          return mapAbsoluteFontSize(key, value);</span>
        }
      }
      return [key, value];
    })
 ...
 * @return {array}
 */
function <span class="fstat-no" title="function not covered" >mapAbsoluteFontSize(</span>key, value) {
  let fontSize = <span class="cstat-no" title="statement not covered" >value;</span>
<span class="cstat-no" title="statement not covered" >  if (ABSOLUTE_FONT_SIZE.hasOwnProperty(value)) {</span>
<span class="cstat-no" title="statement not covered" >    fontSize = ABSOLUTE_FONT_SIZE[value];</span>
  }
<span class="cstat-no" title="statement not covered" >  return [key, fontSize];</span>
}
&nbsp;
/**
 ...
 */
export function cssStringToRNStyle(str, styleset = <span class="branch-0 cbranch-no" title="branch not covered" >STYLESETS.TEXT,</span> options) {
